...
const DICT = {
  ...
  'settings.about.what.body': {
    es: 'Eco orquesta múltiples agentes de Claude trabajando en paralelo, cada uno con su propio worktree git aislado, terminal real, dev server con puerto único y navegador interno. Te permite chatear, dar comandos por voz o texto, ver diffs antes de commitear, y guardar tus sesiones en Obsidian. Todo corre 100% local en tu Mac.',
    en: 'Eco orchestrates multiple Claude agents working in parallel, each with its own isolated git worktree, real terminal, dev server on a unique port, and internal browser. You can chat, give voice or text commands, review diffs before committing, and save sessions to Obsidian. Everything runs 100% local on your Mac.',
  },
  ...
  'settings.about.feat.agents.body':   { es: 'Múltiples conversaciones simultáneas con Claude, aisladas por git worktree.', en: 'Multiple simultaneous Claude conversations, isolated by git worktree.' },
  'settings.about.feat.terminal.title': { es: 'Terminal real', en: 'Real terminal' },
  'settings.about.feat.terminal.body':  { es: 'PTY zsh por agente con xterm.js. Persiste si salís y volvés.', en: 'PTY zsh per agent with xterm.js. Persists if you leave and return.' },
  'settings.about.feat.browser.title':  { es: 'Navegador integrado', en: 'Integrated browser' },
  'settings.about.feat.browser.body':   { es: '<webview> Chromium real con tabs, marcadores y DevTools nativos.', en: 'Real Chromium <webview> with tabs, bookmarks and native DevTools.' },
  'settings.about.feat.server.title':   { es: 'Dev server', en: 'Dev server' },
  'settings.about.feat.server.body':    { es: 'Un dev server por agente con puerto único. Auto-retry en conflictos.', en: 'One dev server per agent with unique port. Auto-retry on conflicts.' },
  'settings.about.feat.git.title':      { es: 'Git integrado', en: 'Built-in git' },
  'settings.about.feat.git.body':       { es: 'Branch picker, commit con IA (preview editable), pull/fetch/rename.', en: 'Branch picker, AI commit (editable preview), pull/fetch/rename.' },
  'settings.about.feat.voice.title':    { es: 'Voz local', en: 'Local voice' },
  'settings.about.feat.voice.body':     { es: 'Wake word + STT con Whisper local. TTS con Piper. Sin la nube.', en: 'Wake word + STT with local Whisper. TTS with Piper. Cloud-free.' },
  'settings.about.feat.obsidian.title': { es: 'Obsidian', en: 'Obsidian' },
  'settings.about.feat.obsidian.body':  { es: 'Lee MOC + última sesión del proyecto. Guarda sesiones automáticamente.', en: 'Reads project MOC + last session. Saves sessions automatically.' },
  'settings.about.feat.skills.title':   { es: 'Skills', en: 'Skills' },
  'settings.about.feat.skills.body':    { es: 'Slash commands de Claude Code detectados de tu vault. Picker integrado.', en: 'Claude Code slash commands detected from your vault. Built-in picker.' },

...
const DICT = {
  ...
  'admin.reset.pin': { es: 'Nuevo PIN', en: 'New PIN' },
  'admin.reset.btn': { es: 'Resetear PIN', en: 'Reset PIN' },
  'admin.recovery.title': { es: 'Frase de recuperación', en: 'Recovery phrase' },
  'admin.recovery.sub': { es: 'Pasale estas 12 palabras al usuario por un canal seguro. No se vuelven a mostrar.', en: 'Share these 12 words with the user over a secure channel. They will not be shown again.' },
  'admin.recovery.done': { es: 'Listo', en: 'Done' },
  ...
  'berr.admin.reset_failed': { es: 'No se pudo resetear el PIN', en: 'Could not reset the PIN' },

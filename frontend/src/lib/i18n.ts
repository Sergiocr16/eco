...
const DICT = {
  ...
  'auth.login.sub': {
    es: 'Ingresá tu usuario y PIN',
    en: 'Enter your username and PIN',
  },
  'auth.forgot_pin': {
  ...
  'account.signout.sub': { es: 'Pide usuario y PIN al volver', en: 'Requires username and PIN next time' },
  ...
  'server.cfg.admin_defined': { es: 'Configurado por el admin para este workspace.', en: 'Configured by the admin for this workspace.' },
  'server.cfg.admin_edit_hint': { es: 'Editalo en Ajustes → Carpetas.', en: 'Edit it in Settings → Folders.' },
  'server.cfg.none_admin': { es: 'Este workspace no tiene server configurado. Definilo en Ajustes → Carpetas.', en: 'This workspace has no server configured. Set it in Settings → Folders.' },
  'server.cfg.none_member': { es: 'Este workspace no tiene server configurado. Pedile a un admin que lo configure.', en: 'This workspace has no server configured. Ask an admin to set it up.' },

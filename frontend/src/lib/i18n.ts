...
const DICT = {
  ...
  'auth.lock.sub': { es: 'Ingresá tu PIN para continuar', en: 'Enter your PIN to continue' },
  'auth.switch_user': { es: 'Cambiar de usuario', en: 'Switch user' },
  'auth.have_claim_code': { es: '¿Tenés un código de activación?', en: 'Have an activation code?' },
  'auth.claim.title': { es: 'Activar cuenta', en: 'Activate account' },
  'auth.claim.sub': { es: 'Pegá el código que te pasó el admin y elegí tu PIN.', en: 'Paste the code your admin shared and choose your PIN.' },
  'auth.claim.field.code': { es: 'Código de activación', en: 'Activation code' },
  'auth.claim.btn': { es: 'Activar y entrar', en: 'Activate and enter' },
  'auth.claim.btn_loading': { es: 'Activando…', en: 'Activating…' },
  'auth.login.title': { es: 'Entrar a Eco', en: 'Sign in to Eco' },
  'auth.login.sub': {
    es: 'Ingresá tu email y contraseña',
    en: 'Enter your email and password',
  },
  'auth.field.email': { es: 'Email', en: 'Email' },
  'auth.field.password': { es: 'Contraseña', en: 'Password' },
  'auth.login.forgot': { es: '¿Olvidaste tu contraseña?', en: 'Forgot your password?' },
  'auth.login.no_account': { es: '¿No tenés cuenta? Registrate', en: "No account? Sign up" },
  'auth.reg.title': { es: 'Crear cuenta', en: 'Create account' },
  'auth.reg.sub': { es: 'Registrate con tu email', en: 'Sign up with your email' },
  'auth.reg.have_account': { es: '¿Ya tenés cuenta? Entrá', en: 'Already have an account? Sign in' },
  'auth.reset.title': { es: 'Recuperar contraseña', en: 'Reset password' },
  'auth.reset.sub': { es: 'Te enviamos un link por email', en: "We'll email you a reset link" },
  'auth.reset.btn': { es: 'Enviar link', en: 'Send link' },
  'auth.reset.btn_loading': { es: 'Enviando…', en: 'Sending…' },
  'auth.reset.sent': {
    es: 'Te enviamos un email para restablecer la contraseña.',
  ...
  'nav.folders': { es: 'Espacios', en: 'Workspaces' },
  ...
  'admin.sub': { es: 'Gestioná usuarios, accesos a workspaces y mirá quién trabaja en qué.', en: 'Manage users, workspace access, and see who works on what.' },
  'admin.tab.users': { es: 'Usuarios', en: 'Users' },
  'admin.tab.activity': { es: 'Actividad', en: 'Activity' },
  'admin.tab.audit': { es: 'Bitácora', en: 'Audit log' },
  'admin.audit.filter.user': { es: 'Usuario', en: 'User' },
  'admin.audit.filter.type': { es: 'Tipo', en: 'Type' },
  'admin.audit.filter.all': { es: 'Todos', en: 'All' },
  'admin.audit.empty': { es: 'Sin eventos', en: 'No events' },
  'admin.audit.unknown_user': { es: 'Desconocido', en: 'Unknown' },
  'admin.audit.type.auth.login': { es: 'Inició sesión', en: 'Logged in' },
  'admin.audit.type.auth.claim': { es: 'Activó cuenta', en: 'Activated account' },
  'admin.audit.type.auth.logout': { es: 'Cerró sesión', en: 'Logged out' },
  'admin.audit.type.bubble.create': { es: 'Creó un agente', en: 'Created an agent' },
  'admin.audit.type.bubble.archive': { es: 'Archivó un agente', en: 'Archived an agent' },
  'admin.audit.type.bubble.delete': { es: 'Borró un agente', en: 'Deleted an agent' },
  'admin.create.title': { es: 'Crear usuario', en: 'Create user' },
  'admin.create.username': { es: 'Nombre de usuario', en: 'Username' },
  'admin.create.pin': { es: 'PIN (4–8 dígitos)', en: 'PIN (4–8 digits)' },
  'admin.create.btn': { es: 'Crear', en: 'Create' },
  'admin.err.name_pin': { es: 'Ingresá un usuario y un PIN de 4 a 8 dígitos', en: 'Enter a username and a 4–8 digit PIN' },
  'admin.err.name': { es: 'Ingresá un nombre de usuario', en: 'Enter a username' },
  'admin.empty': { es: 'No hay usuarios todavía', en: 'No users yet' },
  'admin.newuser.title': { es: 'Crear usuario', en: 'Create user' },
  'admin.newuser.email': { es: 'Email', en: 'Email' },
  'admin.newuser.name': { es: 'Nombre (opcional)', en: 'Name (optional)' },
  'admin.newuser.btn': { es: 'Crear', en: 'Create' },
  'admin.newuser.creating': { es: 'Creando…', en: 'Creating…' },
  'admin.newuser.done.title': { es: 'Usuario creado', en: 'User created' },
  'admin.newuser.done.sub': {
    es: 'Compartile estas credenciales por un canal seguro. Puede cambiar la contraseña al entrar.',
    en: 'Share these credentials over a secure channel. They can change the password after signing in.',
  },
  'admin.newuser.done.copy': { es: 'Copiar', en: 'Copy' },
  'admin.newuser.done.copied': { es: 'Copiado', en: 'Copied' },
  'admin.newuser.done.close': { es: 'Listo', en: 'Done' },
  'admin.reset.send': { es: 'Enviar reset', en: 'Send reset' },
  'admin.reset.sent': { es: 'Email enviado', en: 'Email sent' },
  'admin.you': { es: 'vos', en: 'you' },
  'admin.manage': { es: 'Gestionar', en: 'Manage' },
  'admin.close': { es: 'Cerrar', en: 'Close' },
  'admin.delete': { es: 'Borrar', en: 'Delete' },
  'admin.role.label': { es: 'Rol', en: 'Role' },
  'admin.role.admin': { es: 'Admin', en: 'Admin' },
  'admin.role.member': { es: 'Miembro', en: 'Member' },
  'admin.role.make_admin': { es: 'Hacer admin', en: 'Make admin' },
  'admin.role.make_member': { es: 'Hacer miembro', en: 'Make member' },
  'admin.grants_count_one': { es: '{{n}} workspace', en: '{{n}} workspace' },
  'admin.grants_count_many': { es: '{{n}} workspaces', en: '{{n}} workspaces' },
  'admin.grants_count': { es: '{{n}} workspaces', en: '{{n}} workspaces' },
  'admin.workspaces.label': { es: 'Workspaces permitidos', en: 'Allowed workspaces' },
  'admin.workspaces.admin_all': { es: 'Los admin acceden a todos los workspaces.', en: 'Admins can access all workspaces.' },
  'admin.workspaces.none_configured': { es: 'No hay workspaces en el sistema. Agregá carpetas en Ajustes.', en: 'No workspaces in the system. Add folders in Settings.' },
  'admin.workspaces.save': { es: 'Guardar accesos', en: 'Save access' },
  'admin.reset.btn': { es: 'Generar código de reseteo', en: 'Generate reset code' },
  'admin.disable': { es: 'Deshabilitar', en: 'Disable' },
  'admin.enable': { es: 'Habilitar', en: 'Enable' },
  'admin.status.pending': { es: 'Pendiente', en: 'Pending' },
  'admin.status.disabled': { es: 'Deshabilitada', en: 'Disabled' },
  'admin.claim.title': { es: 'Código de activación', en: 'Activation code' },
  'admin.claim.sub': { es: 'Pasale este código al usuario por un canal seguro. Lo usa una sola vez para definir su PIN. No se vuelve a mostrar.', en: 'Share this code with the user over a secure channel. They use it once to set their PIN. It will not be shown again.' },
  'admin.claim.copy': { es: 'Copiar código', en: 'Copy code' },
  'admin.claim.copied': { es: 'Copiado', en: 'Copied' },
  'admin.claim.done': { es: 'Listo', en: 'Done' },
  'admin.activity.count': { es: '{{n}} bubbles', en: '{{n}} bubbles' },
  'admin.activity.idle': { es: 'Sin bubbles activas', en: 'No active bubbles' },
  'admin.activity.loading': { es: 'Cargando actividad…', en: 'Loading activity…' },
  ...
  'account.password': { es: 'Cambiar contraseña', en: 'Change password' },
  'account.password.sub': { es: 'Actualizá tu contraseña de acceso', en: 'Update your sign-in password' },
  'account.password.current': { es: 'Contraseña actual', en: 'Current password' },
  'account.password.new': { es: 'Nueva contraseña', en: 'New password' },
  'account.password.confirm': { es: 'Repetir nueva contraseña', en: 'Repeat new password' },
  'account.password.save': { es: 'Guardar', en: 'Save' },
  'account.password.saving': { es: 'Guardando…', en: 'Saving…' },
  'account.password.cancel': { es: 'Cancelar', en: 'Cancel' },
  'account.password.close': { es: 'Listo', en: 'Done' },
  'account.password.done': { es: 'Contraseña actualizada.', en: 'Password updated.' },
  'account.password.err_short': { es: 'La nueva contraseña debe tener al menos 6 caracteres.', en: 'The new password must be at least 6 characters.' },
  'account.password.err_mismatch': { es: 'Las contraseñas no coinciden.', en: 'Passwords do not match.' },
  'account.signout': { es: 'Cerrar sesión', en: 'Sign out' },
  'account.signout.sub': { es: 'Cierra la sesión de Firebase', en: 'Signs out of Firebase' },
  'lock.title': { es: 'Pantalla bloqueada', en: 'Screen locked' },
  'lock.sub': { es: 'Ingresá tu PIN para continuar', en: 'Enter your PIN to continue' },
  'lock.sub_user': { es: 'Hola {{name}}, ingresá tu PIN', en: 'Hi {{name}}, enter your PIN' },
  'lock.pin': { es: 'PIN', en: 'PIN' },
  'lock.unlock': { es: 'Desbloquear', en: 'Unlock' },
  'lock.unlock_loading': { es: 'Verificando…', en: 'Checking…' },
  'lock.signout': { es: 'Cerrar sesión', en: 'Sign out' },
  'lock.setup.title': { es: 'Creá tu PIN', en: 'Create your PIN' },
  'lock.setup.sub': { es: 'Un PIN de 4 a 8 dígitos para desbloquear rápido sin cerrar sesión.', en: 'A 4–8 digit PIN to quickly unlock without signing out.' },
  'lock.setup.pin': { es: 'PIN (4–8 dígitos)', en: 'PIN (4–8 digits)' },
  'lock.setup.confirm': { es: 'Repetir PIN', en: 'Repeat PIN' },
  'lock.setup.create': { es: 'Guardar PIN', en: 'Save PIN' },
  'lock.setup.creating': { es: 'Guardando…', en: 'Saving…' },
  'lock.setup.skip': { es: 'Más tarde', en: 'Later' },
  'lock.setup.short': { es: 'El PIN debe tener entre 4 y 8 dígitos.', en: 'The PIN must be 4 to 8 digits.' },
  'lock.setup.mismatch': { es: 'Los PIN no coinciden.', en: 'PINs do not match.' },
  ...
  'dash.scope.mine': { es: 'Mis agentes', en: 'My agents' },
  'dash.scope.all': { es: 'Todos los usuarios', en: 'All users' },
  'dash.no_owner': { es: 'Sin dueño', en: 'No owner' },
  'dash.bubble.owner': { es: 'Dueño', en: 'Owner' },
  ...
  'berr.auth.registration_closed': { es: 'El registro está cerrado; pedile al admin que cree tu cuenta', en: 'Registration is closed; ask the admin to create your account' },
  'berr.auth.username_taken': { es: 'Ese nombre de usuario ya existe', en: 'That username already exists' },
  'berr.auth.login_wrong': { es: 'Usuario o PIN incorrectos', en: 'Wrong username or PIN' },
  'berr.auth.login_required': { es: 'Usuario y PIN requeridos', en: 'Username and PIN required' },
  'berr.auth.refresh_invalid': { es: 'Sesión expirada — iniciá sesión de nuevo', en: 'Session expired — sign in again' },
  'berr.auth.claim_invalid': { es: 'Código de activación inválido', en: 'Invalid activation code' },
  'berr.auth.claim_expired': { es: 'El código de activación expiró — pedile uno nuevo al admin', en: 'The activation code expired — ask the admin for a new one' },
  'berr.auth.claim_failed': { es: 'No se pudo activar la cuenta', en: 'Could not activate the account' },
  'berr.admin.required': { es: 'Requiere rol admin', en: 'Requires admin role' },
  'berr.admin.create_failed': { es: 'No se pudo crear el usuario', en: 'Could not create the user' },
  'berr.admin.bad_id': { es: 'Id inválido', en: 'Invalid id' },
  'berr.admin.cant_delete_self': { es: 'No podés borrar tu propia cuenta acá', en: 'You cannot delete your own account here' },
  'berr.admin.cant_demote_self': { es: 'No podés quitarte el rol admin a vos mismo', en: 'You cannot remove your own admin role' },
  'berr.admin.role_failed': { es: 'No se pudo cambiar el rol', en: 'Could not change the role' },
  'berr.admin.grants_failed': { es: 'No se pudieron asignar los workspaces', en: 'Could not assign workspaces' },
  'berr.admin.reset_failed': { es: 'No se pudo generar el código', en: 'Could not generate the code' },
  'berr.admin.cant_disable_self': { es: 'No podés deshabilitar tu propia cuenta', en: 'You cannot disable your own account' },
  'berr.admin.disable_failed': { es: 'No se pudo cambiar el estado', en: 'Could not change the status' },
  ...
  'berr.search.no_engine': { es: 'No se encontró el motor de búsqueda (ripgrep)', en: 'Search engine (ripgrep) not found' },
  ...
  'detail.btn.dictating_title': { es: 'Detener dictado', en: 'Stop dictation' },
  'detail.dictation.placeholder': { es: 'Hablá… lo que digas aparece acá', en: 'Speak… what you say appears here' },
  ...
  'archived.delete_permanent': { es: 'Eliminar', en: 'Delete' },
  'archived.delete_permanent_tooltip': { es: 'Ocultar el agente (se conserva en la nube)', en: 'Hide the agent (kept in the cloud)' },
  'archived.delete_confirm_title': { es: '¿Eliminar este agente?', en: 'Delete this agent?' },
  'archived.delete_confirm_body': { es: 'El agente se ocultará en todos lados y se liberarán sus recursos locales (worktree/terminal). Sus datos quedan guardados en la nube por si hay que recuperarlo; no se borran del todo.', en: 'The agent will be hidden everywhere and its local resources (worktree/terminal) freed. Its data stays in the cloud in case it needs to be recovered; it is not fully erased.' },
  ...
  'settings.backup.auto.label': { es: 'Backup automático (cada 2 h)', en: 'Automatic backup (every 2h)' },
  'settings.backup.auto.toggle_title': { es: 'Activar backup automático', en: 'Enable automatic backup' },
  'settings.backup.auto.toggle_desc': { es: 'Cada 2h, en la máquina anfitriona, Eco respalda a TODOS los usuarios en la carpeta elegida.', en: 'Every 2h, on the host machine, Eco backs up ALL users into the chosen folder.' },
  ...
  // Diff viewer / merge view (nuevo)
  'diff.scope.unstaged': { es: 'Nuevos', en: 'New' },
  'diff.scope.all': { es: 'Todos', en: 'All' },
  'diff.scope.unstaged_tooltip': { es: 'Solo cambios sin aceptar (working tree vs index)', en: 'Only unaccepted changes (working tree vs index)' },
  'diff.scope.all_tooltip': { es: 'Todos los cambios desde el último commit (vs HEAD)', en: 'All changes since the last commit (vs HEAD)' },
  'diff.compact.full': { es: 'Archivo completo', en: 'Whole file' },
  'diff.compact.compact': { es: 'Vista compacta', en: 'Compact view' },
  'diff.compact.expand_tooltip': { es: 'Mostrar el archivo completo expandido', en: 'Show the whole file expanded' },
  'diff.compact.compact_tooltip': { es: 'Solo regiones cambiadas con 3 líneas de contexto', en: 'Only changed regions with 3 lines of context' },
  'diff.reviewed': { es: 'Revisado', en: 'Reviewed' },
  'diff.discard_file': { es: 'Descartar archivo', en: 'Discard file' },
  'diff.discard_file_tooltip': { es: 'Descartar todos los cambios del archivo (git checkout HEAD)', en: 'Discard all changes in the file (git checkout HEAD)' },
  'diff.accept_file': { es: 'Aceptar archivo', en: 'Accept file' },
  'diff.accept_file_tooltip': { es: 'Marcar el archivo como revisado (no toca el filesystem)', en: 'Mark the file as reviewed (does not touch the filesystem)' },
  'diff.accept': { es: 'Aceptar', en: 'Accept' },
  'diff.accepted_short': { es: 'OK', en: 'OK' },
  'diff.reject': { es: 'Rechazar', en: 'Reject' },
  'diff.prev_change': { es: 'Cambio anterior', en: 'Previous change' },
  'diff.next_change': { es: 'Cambio siguiente', en: 'Next change' },
  'diff.change_counter': { es: 'Cambio {{n}} / {{total}}', en: 'Change {{n}} / {{total}}' },
  'diff.revert_hunk_tooltip': { es: 'Revertir este cambio (git apply -R)', en: 'Revert this change (git apply -R)' },
  'diff.accept_hunk_tooltip': { es: 'Marcar este cambio como revisado', en: 'Mark this change as reviewed' },
  ...
  'settings.folders.sub': {
    es: 'Tus proyectos: Eco solo puede leer y escribir dentro de estas rutas.',
    en: 'Your projects: Eco can only read and write within these paths.',
  },
  ...
  'settings.folders.search': { es: 'Buscar espacio de trabajo…', en: 'Search workspace…' },
  'settings.folders.no_match': { es: 'Ningún espacio coincide con la búsqueda.', en: 'No workspace matches your search.' },
  ...
  'settings.appearance.accent.override': { es: 'Acento (override)', en: 'Accent (override)' },
  'settings.appearance.accent.override_desc': {
    es: 'Cada tema ya trae su acento coordinado. Acá podés sobrescribirlo; vuelve al del tema al cambiar de tema.',
    en: 'Each theme ships its own coordinated accent. Override it here; it resets to the theme default when you switch themes.',
  },
  'settings.appearance.accent.reset': { es: 'Restablecer', en: 'Reset' },
  // Nombres de los temas curados (bilingüe).
  'settings.appearance.theme.name.dark': { es: 'Grafito', en: 'Graphite' },
  'settings.appearance.theme.name.slate': { es: 'Azul Rey', en: 'Royal Blue' },
  'settings.appearance.theme.name.ocean': { es: 'Océano', en: 'Ocean' },
  'settings.appearance.theme.name.emerald': { es: 'Esmeralda', en: 'Emerald' },
  'settings.appearance.theme.name.dracula': { es: 'Violeta', en: 'Violet' },
  'settings.appearance.theme.name.indigo': { es: 'Índigo', en: 'Indigo' },
  'settings.appearance.theme.name.rose-pine': { es: 'Rosa', en: 'Rose' },
  'settings.appearance.theme.name.gruvbox': { es: 'Ámbar', en: 'Amber' },
  'settings.appearance.theme.name.blood-moon': { es: 'Carmesí', en: 'Crimson' },
  'settings.appearance.theme.name.light': { es: 'Claro', en: 'Light' },
  'settings.appearance.theme.name.sky': { es: 'Cielo', en: 'Sky' },
  ...
  'files.search.whole_word': { es: 'Palabra completa', en: 'Whole word' },
  ...
  'files.quickopen.title': { es: 'Buscar archivo por nombre', en: 'Find file by name' },
  ...
  'prs.detail.draft_hint': { es: 'Este PR es borrador — marcalo listo para revisión antes de mergear.', en: 'This PR is a draft — mark it ready for review before merging.' },
  ...
  'prs.detail.ready_btn': { es: 'Listo para revisión', en: 'Ready for review' },
  'prs.detail.ready_tooltip': { es: 'Sacar el PR de borrador para poder mergearlo', en: 'Take the PR out of draft so it can be merged' },
  ...
  'prs.ready.ok': { es: 'PR #{{n}} listo para revisión', en: 'PR #{{n}} ready for review' },
  'prs.ready.fail': { es: 'No se pudo sacar de borrador', en: 'Could not mark as ready' },
  ...
  'prs.ready_confirm.title': { es: '¿Marcar el PR #{{n}} como listo para revisión?', en: 'Mark PR #{{n}} as ready for review?' },
  'prs.ready_confirm.body': { es: 'El PR deja de ser borrador en GitHub y queda abierto a review. Se notifica a los reviewers asignados y ya se puede mergear. Podés volver a convertirlo en borrador desde GitHub.', en: 'The PR stops being a draft on GitHub and is opened for review. Assigned reviewers are notified and it becomes mergeable. You can convert it back to a draft from GitHub.' },
  'prs.ready_confirm.confirm': { es: 'Sí, marcar listo', en: 'Yes, mark ready' },
  ...
  'prs.banner.open_detail': { es: 'Abrir el detalle del PR', en: 'Open PR detail' },
  ...
  'prs.banner.ready_btn': { es: 'Listo p/ revisión', en: 'Ready for review' },
  'prs.banner.readying': { es: 'Marcando…', en: 'Marking…' },
  'prs.banner.ready_tooltip': { es: 'Sacar el PR de borrador para poder mergearlo', en: 'Take the PR out of draft so it can be merged' },
  ...
  'prs.banner.confirm_ready.title': { es: '¿Marcar el PR #{{n}} como listo para revisión?', en: 'Mark PR #{{n}} as ready for review?' },
  'prs.banner.confirm_ready.body': { es: 'Deja de ser borrador en GitHub: se notifica a los reviewers y el PR pasa a ser mergeable.', en: 'It stops being a draft on GitHub: reviewers are notified and the PR becomes mergeable.' },
  ...
  'server.cfg.edit_hint': { es: 'Configurado para este workspace. Editalo en Ajustes → Carpetas.', en: 'Configured for this workspace. Edit it in Settings → Folders.' },
  'server.cfg.none': { es: 'Este workspace no tiene server configurado. Definilo en Ajustes → Carpetas.', en: 'This workspace has no server configured. Set it in Settings → Folders.' },
  'server.cfg.env_label': { es: 'Variables de entorno', en: 'Environment variables' },
  ...
  'settings.srv.label': { es: 'Comando(s) del dev server', en: 'Dev server command(s)' },
  ...
  'settings.srv.env.label': { es: 'Variables de entorno', en: 'Environment variables' },
  'settings.srv.env.add': { es: 'Agregar variable', en: 'Add variable' },
  'settings.srv.env.key_ph': { es: 'NOMBRE', en: 'NAME' },
  'settings.srv.env.value_ph': { es: 'valor', en: 'value' },
  'settings.srv.env.remove': { es: 'Quitar variable', en: 'Remove variable' },
  'settings.srv.env.invalid': { es: 'Nombre inválido: usá letras, números y _, sin empezar con número.', en: 'Invalid name: use letters, digits and _, must not start with a digit.' },
  'settings.srv.env.hint': { es: 'Se inyectan al arrancar cada server de este workspace. PORT, HOST y los puertos los administra Eco y pisan cualquier valor definido acá.', en: 'Injected when starting every server in this workspace. PORT, HOST and ports are managed by Eco and override anything set here.' },
  'settings.srv.env.import': { es: 'Importar .env', en: 'Import .env' },
  'settings.srv.env.import_tip': { es: 'Archivo formato dotenv: NOMBRE=valor por línea, # comenta, se admiten prefijo export y comillas.', en: 'Dotenv-format file: NAME=value per line, # comments, export prefix and quotes supported.' },
  'settings.srv.env.import_ok': { es: 'Se importaron {{n}} variables — revisá y guardá.', en: 'Imported {{n}} variables — review and save.' },
  'settings.srv.env.import_skipped': { es: '{{n}} líneas ignoradas (formato inválido, ECO_* o límite de 50).', en: '{{n}} lines skipped (invalid format, ECO_* or the 50-var cap).' },
  'settings.srv.env.import_empty': { es: 'El archivo no contiene variables válidas.', en: 'The file has no valid variables.' },
  'settings.srv.env.too_long': { es: 'Hay valores de más de 4000 caracteres — acortalos para poder guardar.', en: 'Some values exceed 4000 characters — shorten them to save.' },
  'settings.srv.env.export': { es: 'Exportar .env', en: 'Export .env' },
  'settings.srv.env.export_tip': { es: 'Descarga las variables actuales (incluye cambios sin guardar) como archivo .env.', en: 'Download the current variables (including unsaved edits) as a .env file.' },
  'settings.srv.env.export_header': { es: '# Variables de entorno — {{ws}} (Eco)', en: '# Environment variables — {{ws}} (Eco)' },
  'settings.srv.env.format_label': { es: 'Formato del archivo (.env / dotenv):', en: 'File format (.env / dotenv):' },
  'settings.srv.env.format_example': {
    es: '# comentario\nNOMBRE=valor\nCON_COMILLAS="valor con espacios o #"\nexport TAMBIEN_VALE=1',
    en: '# comment\nNAME=value\nQUOTED="value with spaces or #"\nexport ALSO_WORKS=1',
  },
  ...
  'settings.folders.config_show': { es: 'Configurar servidor y ramas', en: 'Configure server and branches' },
  'settings.folders.config_hide': { es: 'Ocultar configuración', en: 'Hide configuration' },
  'settings.tailnet.label': { es: 'Acceso remoto', en: 'Remote access' },
  'settings.tailnet.title': { es: 'Publicar Eco en la tailnet', en: 'Publish Eco on the tailnet' },
  'settings.tailnet.desc': {
  ...
  'settings.tailnet.hint': {
    es: 'Solo tu tailnet puede entrar — nunca se expone a internet. El login sigue siendo el mismo.',
    en: 'Only your tailnet can reach it — it is never exposed to the internet. Login is unchanged.',
  },
  'split.list': { es: 'Lista', en: 'List' },
  'split.detail': { es: 'Detalle', en: 'Detail' },
  'files.mobile.tree': { es: 'Archivos', en: 'Files' },
  'files.mobile.editor': { es: 'Editor', en: 'Editor' },
  'notes.mobile.list': { es: 'Notas', en: 'Notes' },
  'notes.mobile.editor': { es: 'Editor', en: 'Editor' },
  'term.keybar.font_smaller': { es: 'Achicar la letra del terminal', en: 'Decrease terminal font size' },
  'term.keybar.font_bigger': { es: 'Agrandar la letra del terminal', en: 'Increase terminal font size' },
